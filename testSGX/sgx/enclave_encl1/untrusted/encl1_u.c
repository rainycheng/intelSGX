...
sgx_status_t ecall_encl1_update_operation(sgx_enclave_id_t eid, char* key, int* flag, int* vlen, char* value, char* value_update, int str_len)
{
	sgx_status_t status;
